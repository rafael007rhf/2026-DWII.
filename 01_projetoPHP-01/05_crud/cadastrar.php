...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($erro === '') {
        ...
        $sql = 'INSERT INTO projetos (nome, descricao, tecnologias, link_github, ano) VALUES (:nome, :descricao, :tecnologias, :link_github, :ano)';
...
<div class="container">
    ...
    <?php if ($erro): ?>
        <div class="alerta-erro">
            <p style="margin: 0; font-size: 14px;">a <?php echo htmlspecialchars($erro); ?></p>
        </div>
    <?php endif; ?>
    ...
    <div class="form-container">
        <form action="cadastrar.php" method="post">
            ...
            <label for="nome">Nome do Projeto: <span style="color: #cf1c21;">*</span></label>
            ...
            <textarea id="descricao" name="descricao" rows="4" placeholder="Descreva o projeto em 2-3 frases..."><?php echo htmlspecialchars($form['descricao']); ?></textarea>

            <label for="tecnologias">Tecnologias usadas: <span style="color: #cf1c21;">*</span></label>
            <input type="text" id="tecnologias" name="tecnologias" value="<?php echo htmlspecialchars($form['tecnologias']); ?>" placeholder="Ex.: PHP, MariaDB, HTML, CSS" maxlength="200">
