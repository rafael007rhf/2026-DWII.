 ...
 * Data : 06/04/2026
 * Descrição : Implementa o U do CRUD (update). Este arquivo tem 3 responsabilidades:
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($erro === '') {
        ...
        $stmt->execute([':nome' => $nome, ':descricao' => $descricao, ':tecnologias' => $tecnologias, ':link_github' => $link_github !== '' ? $link_github: null, ':ano' => $ano, ':id' => $id,]);
